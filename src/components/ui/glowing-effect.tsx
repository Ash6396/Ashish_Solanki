          ...
          style={
            {
              ...
              "--gradient":
                variant === "white"
                  ...
                  : `radial-gradient(circle, #3b82f6 10%, #3b82f600 22%),
                radial-gradient(circle at 40% 40%, #6366f1 8%, #6366f100 22%),
                radial-gradient(circle at 60% 60%, #22d3ee 10%, #22d3ee00 25%),
                radial-gradient(circle at 40% 60%, #a78bfa 10%, #a78bfa00 25%),
                repeating-conic-gradient(
                  from 236.84deg at 50% 50%,
                  #3b82f6 0%,
